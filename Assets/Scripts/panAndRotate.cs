...
// *** Controls Panning and Rotating of Selected Objects with Respect to Mouse and Touch Inputs ***

public class panAndRotate : MonoBehaviour
{
    ...
    public void playComponentAudio()
    {
        Debug.Log("IsPlaying ");
